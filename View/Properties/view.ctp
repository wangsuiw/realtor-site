...
<div style="width:700px; height:450px; 
				...
				margin-top:50px;
				background:#93946B">
	<ul class="tab-button"><li class="current">Photos</li>
		<li><?php echo $this->Html->link('Map', array( 'controller' => 'properties', 'action' => 'map', $property['Property']['property_id'])); ?></li>
	</ul>
	<p>
	<a class="fancybox-thumbs" href="<?php echo '../../img/property/'.$property['Property']['property_id'].'/650x400/'.$property['Property']['image']; ?>" data-fancybox-group="thumb" title="<?php echo $property['Property']['address']; ?>">
	<?php
		echo $this->Html->image(
			'/img/property/'.$property['Property']['property_id'].'/650x400/'.$property['Property']['image'],
			array(
				'width' => '648px',
				'height' => '398px',
	...
	{
		$pathtofile= '/img/property/'.$property['Property']['property_id'].'/images/'.$file;
		$counter = $counter + 1;
	
	?>
	<a class="fancybox-thumbs" href="<?php echo '../../'.$pathtofile ?>" data-fancybox-group="thumb" title="Photo <?php echo $counter ?>">
